    ...
    public String initialFileUpload( HttpSession session,@RequestParam CommonsMultipartFile fileUpload) throws Exception {
         ...
         if (fileUpload != null ) {
             ...
             if(getUploadFile!=null)
             {
                 ...
                 try{
		         		File file=new File("C:/Users/AnilreddyBanda/Desktop/PalsConnect-master/PalsConnectFE/WebContent/images/images/"+pals.getUsername());
         ...
         return "redirect:http://localhost:8989/PalsConnectBE/#/welcome";
    }	
