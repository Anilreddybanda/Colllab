app.factory('ProfileService',function($http){
	...
	profileService.getblogs=function(){
		...
		return $http.get("http://localhost:8989/PalsConnectBE/getblogs")
	}
	
	profileService.getfriends=function()
	{
		console.log('get friends in profileservice')
		return $http.get("http://localhost:8989/PalsConnectBE/getfriends")
	}
	
	profileService.deleteblog=function(id){
		return $http.delete("http://localhost:8989/PalsConnectBE/deleteblog/"+id)
	}
